---
name: obsidian-bases
description: Use when working with .base files in Obsidian, creating database-like views of notes, or when the user mentions Bases, table views, card views, filters, formulas, or summaries
---
