...
**Launch 4-6 researchers in parallel for comprehensive coverage:**

```
// Professional Background
Task({ subagent_type: "general-purpose", prompt: "Research [name] professional background, career history, and credentials" })

// Public Records
Task({ subagent_type: "general-purpose", prompt: "Search public records for [name] including court records, business filings, property" })

// Digital Footprint
Task({ subagent_type: "general-purpose", prompt: "Map digital footprint for [name] - domains, social media, online presence" })

// Credential Verification
Task({ subagent_type: "general-purpose", prompt: "Verify credentials and claims for [name] - education, certifications, experience" })
```
...
**Reference:** See `references/PeopleTools.md` for tool details.
